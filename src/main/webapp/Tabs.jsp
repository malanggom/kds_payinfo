...
<div class="item-tabs">
            ...
            <div class="flexTabsImage" id="menuToggleDevBtn"><i class="noTextCursor fa-solid fa-chevron-right fa-rotate-90 fa-sm"
            ...
            <div class="flexTabsImage" id="menuToggleCustomerBtn"><i class="noTextCursor fa-solid fa-chevron-right fa-rotate-90 fa-sm"
                    style="color: #ffffff;"></i></div>
            ...
            <div class="flexTabsImage" id="menuToggleProjectBtn"><i class="noTextCursor fa-solid fa-chevron-right fa-rotate-90 fa-sm"
                    style="color: #ffffff;"></i></div>
            ...
            <div class="flexTabsImage" id="menuToggleBankBtn"><i class="noTextCursor fa-solid fa-chevron-right fa-rotate-90 fa-sm"
                    style="color: #ffffff;"></i></div>
            ...
            <div class="flexTabsImage" id="menuToggleTaxBsBtn"><i class="noTextCursor fa-solid fa-chevron-right fa-rotate-90 fa-sm"
                    style="color: #ffffff;"></i></div>
            ...
            <div class="flexTabsImage" id="menuToggleTaxBtn"><i class="noTextCursor fa-solid fa-chevron-right fa-rotate-90 fa-sm"
                    style="color: #ffffff;"></i></div>
            ...
            <div class="flexTabsImage" id="menuToggleMachineBtn"><i class="noTextCursor fa-solid fa-chevron-right fa-rotate-90 fa-sm"
                    style="color: #ffffff;"></i></div>
